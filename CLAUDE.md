...
cargo run -- bench gen watdiv --scale 100 --tag dev                # Generate WatDiv benchmark on the fly
cargo run -- bench gen lubm --scale 1 --tag dev                    # Generate LUBM benchmark on the fly
