...
pub trait KeyType: PartialOrd + PartialEq + Clone + FromStr + Debug + Eq + Hash + Ord + Sized {}
impl<KT> KeyType for KT where KT: PartialOrd + PartialEq + Clone + FromStr + Debug + Eq + Hash + Ord + Sized {}
