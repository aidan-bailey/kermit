...
- `IntoTrieIter` derive now validates the input type's generics

## [0.0.6] - 2026-05-05

### Changed

- Expand README and crate-level example
...
- Add inline documentation to proc macro code
- Add integration tests for `IntoTrieIter` derive macro
