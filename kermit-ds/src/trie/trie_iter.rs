use crate::trie::{
    ...
    relational_trie::RelationalTrie,
};
...
impl<'a, KT: PartialOrd + PartialEq + Clone> TrieIter<'a, KT> {
    ...
    pub fn new(trie: &'a RelationalTrie<KT>) -> Self {
        TrieIter {
            pos: 0,
            trie,
            stack: Vec::new(),
...
impl<KT: PartialOrd + PartialEq + Clone> TrieIterable<KT> for RelationalTrie<KT> {
